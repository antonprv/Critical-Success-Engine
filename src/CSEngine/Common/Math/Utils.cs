...
namespace FastMath
{
	public static partial class FMath
	{
		...
		/// Same single-instruction codegen either way; kept as the pointer
		/// version so every call site in this file stays consistent.
		/// </summary>
		[MethodImpl( MethodImplOptions.AggressiveInlining )]
		...
		/// instead of BitConverter (see AbsBranchless remarks above).
		/// </summary>
		[MethodImpl( MethodImplOptions.AggressiveInlining )]
