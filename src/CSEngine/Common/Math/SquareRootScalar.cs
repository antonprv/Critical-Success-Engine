...
{
	/// <summary>
	/// Fast square-root / inverse-square-root and the scalar-only helpers used
	/// throughout the rest of this file and by the System.Numerics
	/// Vector2/Vector3/Quaternion overloads elsewhere in this project (see
	/// SquareRoot.cs, FastQuaternion.cs). Everything lives in one partial
	/// FMath class in one FastMath namespace now - no separate
	/// Core/Numerics assemblies, no forwarding layer to keep in sync.
	/// </summary>
